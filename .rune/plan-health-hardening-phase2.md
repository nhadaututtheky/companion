...
## Tasks
- [x] T2.1 — CodeGraph ↔ Wiki KB cross-reference
...
- [x] T2.2 — Broadcast CLI debate events to browsers
...
- [x] T2.3 — Connect Debate engine to Mention system
...
- [x] T2.4 — Complete Template Quick Picker
...
- [x] T2.5 — Fix Wiki compiled tracking
...
- [x] T2.6 — Verify build + integration test

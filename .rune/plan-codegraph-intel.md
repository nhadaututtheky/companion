...
|---|------|--------|-----------|---------|
| 1 | Wire Zombie Connections | Pending | plan-codegraph-intel-phase1.md | Fix PostToolUse→event-collector, community→context, codegraph→wiki |
| 2 | Leiden Community Detection | Pending | plan-codegraph-intel-phase2.md | Replace path-based grouping with proper graph clustering |

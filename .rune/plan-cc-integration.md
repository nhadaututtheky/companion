...
| 3 | Debate Mode Upgrade | ✅ Done | plan-cc-integration-phase3.md | Coordinator system prompt, task-notification format, scratchpad |
| 4 | CLI Flag Optimization | ✅ Done | plan-cc-integration-phase4.md | --include-partial-messages, --replay-user-messages, --bare |

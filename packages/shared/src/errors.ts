...
const ERROR_MAP: Array<{ pattern: RegExp; message: string }> = [
  {
    ...
    message: "Directory or file not found. Check that the project path exists.",
  },
  {
  ...
  {
    pattern: /spawn.*ENOENT|not found in PATH/i,
    message: "Claude CLI not found. Make sure it is installed and in your PATH.",
  },
  ...
  { pattern: /ENOMEM|out of memory/i, message: "System is out of memory. Close unused sessions." },
  {
    ...
    message: "Invalid API key. Check your Anthropic API key configuration.",
  },

...
import { rtkRoutes } from "./rtk.js";
import { companionAskRoutes } from "./companion-ask.js";
import { analyticsHarnessRoutes } from "./analytics-harness.js";
...
export function createRoutes(bridge: WsBridge, botRegistry: BotRegistry): Hono {
  ...
  protectedApi.route("/rtk", rtkRoutes);
  protectedApi.route("/companion-ask", companionAskRoutes);
  protectedApi.route("/analytics/harness", analyticsHarnessRoutes);
